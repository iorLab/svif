...
| Portable package / manifests / installation mechanics | Existing package/distribution suites, `check_native_install.py` | Native host receipt must include matching installed bytes, enabled state and new-process discovery. |
