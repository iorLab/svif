...
| Ordinary Project first-use, actual work, checkpoint and fresh-context resume | installed `plugin/skills/svif/SKILL.md`; native `--exercise` | Requires model authentication in isolated home and independent result-file checks. Not proven by a Skill-text assertion. |
